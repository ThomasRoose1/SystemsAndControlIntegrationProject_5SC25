...
typedef struct {
  ...
  real_T Dctleadlag2_RWORK_k[2];       /* '<S43>/Dctleadlag2' */
  real_T Dct1lowpass3_RWORK_c[2];      /* '<S43>/Dct1lowpass3' */
...
struct P_Ball_and_Plate_MicroLabBox_student_T_ {
  ...
  real_T enable_ref_Threshold;         /* Expression: 0
                                        ...
                                        */
  real_T Gain1_Gain;                   /* Expression: 2500
  ...
  real_T Switch_Threshold_a;           /* Expression: 0
                                        ...
                                        */
  real_T Gain1_Gain_l;                 /* Expression: 1500
  ...
  real_T Gain1_Gain_m;                 /* Expression: 60
                                        ...
                                        */
  real_T Dctleadlag2_P1_Size_oo[2];/* Computed Parameter: Dctleadlag2_P1_Size_oo
  ...
  real_T Dctleadlag2_P3_Size_b[2];  /* Computed Parameter: Dctleadlag2_P3_Size_b
                                     * Referenced by: '<S43>/Dctleadlag2'
                                     */
  real_T Dctleadlag2_P3_jd;            /* Expression: 0.001
                                        * Referenced by: '<S43>/Dctleadlag2'
                                        */
  real_T Dct1lowpass3_P1_Size_mm[2];
                                  /* Computed Parameter: Dct1lowpass3_P1_Size_mm
