...
# Workspace (same stable Phase D calibration)
PLATE_X1 = 80
PLATE_Y1 = 20
PLATE_X2 = 530
PLATE_Y2 = 460
...
try:
    while True:
        ...
        display = frame.copy()
        draw_metric_grid(display)

        cv2.rectangle(display, (PLATE_X1, PLATE_Y1), (PLATE_X2, PLATE_Y2), (0, 255, 255), 2)
        cv2.rectangle(display, (SAFE_X1, SAFE_Y1), (SAFE_X2, SAFE_Y2), (0, 0, 255), 2)
        ...
        cv2.imshow('Phase E2 Depth Validation', display)
