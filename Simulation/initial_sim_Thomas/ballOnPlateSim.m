...
while toc < t_sim
    ...
    % % sine waves of current for each actuator
    amplitude = 0.001; 
    I1 = amplitude * sin(2*pi*0.5*t);
    I2 = amplitude * sin(2*pi*0.5*t + 2*pi/3);
    I3 = amplitude * sin(2*pi*0.5*t + 4*pi/3);


    %% Sim update    
    % Actuator update
    [dh1, x_plant1] = actuatorDynamics(I1, x_plant1, dt);
    [dh2, x_plant2] = actuatorDynamics(I2, x_plant2, dt);
    [dh3, x_plant3] = actuatorDynamics(I3, x_plant3, dt);
