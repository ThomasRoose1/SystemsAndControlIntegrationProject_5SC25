...
exportgraphics(fig1, 'Figures/exp_ff_2D.pdf', 'ContentType', 'vector');
exportgraphics(fig2, 'Figures/exp_ff_xy.pdf', 'ContentType', 'vector');
exportgraphics(fig3, 'Figures/exp_ff_angles.pdf', 'ContentType', 'vector');
exportgraphics(fig4, 'Figures/exp_ff_psd.pdf', 'ContentType', 'vector');