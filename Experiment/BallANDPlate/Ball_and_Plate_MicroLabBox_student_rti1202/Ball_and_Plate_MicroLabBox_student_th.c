/************************ dSPACE target specific file *************************
   ...
   Include file .\Ball_and_Plate_MicroLabBox_student_rti1202\Ball_and_Plate_MicroLabBox_student_th.c :

   Task Configuration file for model : Ball_and_Plate_MicroLabBox_student

   RTI1202 7.15 (02-Nov-2020)/2.20
<<<<<<< HEAD
   13-May-2026 12:01:12
=======
   19-May-2026 15:21:40
>>>>>>> Thomas
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Ball_and_Plate_MicroLabBox_student_rti1202\Ball_and_Plate_MicroLabBox_student_th.c is for ST).
# endif
