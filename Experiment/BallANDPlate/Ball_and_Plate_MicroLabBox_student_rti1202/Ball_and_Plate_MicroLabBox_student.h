 ...
 * C source code generated on : Wed Jun 17 18:34:12 2026
 *
...
typedef struct {
  real_T path;                         /* '<S16>/MATLAB Function1' */
} B_MATLABFunction1_Ball_and_Pl_T;

/* Block states (default storage) for system '<S16>/MATLAB Function1' */
typedef struct {
  real_T coeffs[6];                    /* '<S16>/MATLAB Function1' */
  real_T t_elapsed;                    /* '<S16>/MATLAB Function1' */
  real_T prev_ref_end;                 /* '<S16>/MATLAB Function1' */
  real_T tf_internal;                  /* '<S16>/MATLAB Function1' */
  boolean_T prev_ref_end_not_empty;    /* '<S16>/MATLAB Function1' */
...
typedef struct {
  ...
  real_T Gain1_d;                      /* '<S9>/Gain1' */
  real_T Dct1lowpass2_g;               /* '<S9>/Dct1lowpass2' */
  real_T Beta_sat;                     /* '<Root>/Beta_sat ' */
  real_T SFunction1[2];                /* '<S13>/S-Function1' */
  real_T Gain2;                        /* '<Root>/Gain2' */
  real_T Gain3;                        /* '<Root>/Gain3' */
  real_T Switch_h;                     /* '<S16>/Switch' */
  real_T enable_ref;                   /* '<S16>/enable_ref ' */
  real_T Sum1;                         /* '<S16>/Sum1' */
  real_T Gain1_b;                      /* '<S24>/Gain1' */
  real_T Dctleadlag2;                  /* '<S24>/Dctleadlag2' */
  real_T Dct1lowpass3;                 /* '<S24>/Dct1lowpass3' */
  real_T DiscreteTimeIntegrator;       /* '<S24>/Discrete-Time Integrator' */
  real_T Switch2_k;                    /* '<S16>/Switch2' */
  real_T Sum;                          /* '<S16>/Sum' */
  real_T Switch3;                      /* '<S16>/Switch3' */
  real_T Switch1_j;                    /* '<S17>/Switch1' */
  real_T Switch_j;                     /* '<S17>/Switch' */
  real_T Sum1_f;                       /* '<S17>/Sum1' */
  real_T Gain1_f;                      /* '<S37>/Gain1' */
  real_T Dctleadlag2_k;                /* '<S37>/Dctleadlag2' */
  real_T Dct1lowpass3_c;               /* '<S37>/Dct1lowpass3' */
  real_T DiscreteTimeIntegrator_m;     /* '<S37>/Discrete-Time Integrator' */
  real_T Switch2_p;                    /* '<S17>/Switch2' */
  real_T Sum_g;                        /* '<S17>/Sum' */
  real_T Switch3_d;                    /* '<S17>/Switch3' */
  real_T Switch_n;                     /* '<S32>/Switch' */
  real_T Constant1;                    /* '<S32>/Constant1' */
  real_T Constant2;                    /* '<S32>/Constant2' */
  real_T Switch1_k;                    /* '<S18>/Switch1' */
  real_T Switch_jo;                    /* '<S18>/Switch' */
  real_T Sum1_h;                       /* '<S18>/Sum1' */
  real_T Gain2_i;                      /* '<S52>/Gain2' */
  real_T Dctleadlag1;                  /* '<S52>/Dctleadlag1' */
  real_T Dct1lowpass1;                 /* '<S52>/Dct1lowpass1' */
  real_T DiscreteTimeIntegrator_h;     /* '<S52>/Discrete-Time Integrator' */
  real_T Switch2_h;                    /* '<S18>/Switch2' */
  real_T Sum_h;                        /* '<S18>/Sum' */
  real_T Switch3_l;                    /* '<S18>/Switch3' */
  ...
  real_T DataTypeConversion1[4];       /* '<S61>/Data Type Conversion1' */
  real_T DataTypeConversion10[2];      /* '<S61>/Data Type Conversion10' */
  real_T DataTypeConversion11;         /* '<S61>/Data Type Conversion11' */
  real_T DataTypeConversion12[2];      /* '<S61>/Data Type Conversion12' */
  real_T DataTypeConversion13[2];      /* '<S61>/Data Type Conversion13' */
  real_T DataTypeConversion14;         /* '<S61>/Data Type Conversion14' */
  real_T DataTypeConversion15;         /* '<S61>/Data Type Conversion15' */
  real_T DataTypeConversion2;          /* '<S61>/Data Type Conversion2' */
  real_T DataTypeConversion3[2];       /* '<S61>/Data Type Conversion3' */
  real_T DataTypeConversion4[2];       /* '<S61>/Data Type Conversion4' */
  real_T DataTypeConversion5[2];       /* '<S61>/Data Type Conversion5' */
  real_T DataTypeConversion6[4];       /* '<S61>/Data Type Conversion6' */
  real_T DataTypeConversion7[4];       /* '<S61>/Data Type Conversion7' */
  real_T DataTypeConversion8;          /* '<S61>/Data Type Conversion8' */
  real_T DataTypeConversion9[4];       /* '<S61>/Data Type Conversion9' */
  real_T EConversion[2];               /* '<S61>/E Conversion' */
  real_T FConversion[4];               /* '<S61>/F Conversion' */
  real_T GConversion;                  /* '<S61>/G Conversion' */
  real_T MathFunction[4];              /* '<S61>/Math Function' */
  real_T MathFunction1[2];             /* '<S61>/Math Function1' */
  real_T MathFunction2[2];             /* '<S61>/Math Function2' */
  real_T umin_scale4[2];               /* '<S61>/umin_scale4' */
  real_T Reshape[2];                   /* '<S61>/Reshape' */
  real_T ymin_scale1[4];               /* '<S61>/ymin_scale1' */
  real_T Reshape1[4];                  /* '<S61>/Reshape1' */
  real_T SConversion;                  /* '<S61>/S Conversion' */
  real_T ymin_scale2;                  /* '<S61>/ymin_scale2' */
  real_T Reshape2;                     /* '<S61>/Reshape2' */
  real_T Reshape3[4];                  /* '<S61>/Reshape3' */
  real_T Reshape4[2];                  /* '<S61>/Reshape4' */
  real_T Reshape5[2];                  /* '<S61>/Reshape5' */
  real_T extmv_scale[2];               /* '<S61>/ext.mv_scale' */
  real_T extmv_scale1[2];              /* '<S61>/ext.mv_scale1' */
  real_T last_mv[2];                   /* '<S61>/last_mv' */
  real_T last_x[4];                    /* '<S61>/last_x' */
  real_T moorxConversion[4];           /* '<S61>/mo or x Conversion' */
  real_T umin_scale[2];                /* '<S61>/umin_scale' */
  real_T umax_scale[2];                /* '<S61>/umax_scale' */
  real_T ymin_scale[4];                /* '<S61>/ymin_scale' */
  real_T ymax_scale[4];                /* '<S61>/ymax_scale' */
  real_T umin_scale1[2];               /* '<S61>/umin_scale1' */
  real_T umin_scale3[52];              /* '<S61>/umin_scale3' */
  real_T umin_scale5[104];             /* '<S61>/umin_scale5' */
  real_T umin_scale2[2];               /* '<S61>/umin_scale2' */
  real_T Constant9[4];                 /* '<Root>/Constant9' */
  real_T Gain1_k;                      /* '<S10>/Gain1' */
  real_T Dct1lowpass2_k;               /* '<S10>/Dct1lowpass2' */
  real_T xk1[4];                       /* '<S81>/optimizer' */
  real_T u[2];                         /* '<S81>/optimizer' */
  real_T cost;                         /* '<S81>/optimizer' */
  real_T useq[52];                     /* '<S81>/optimizer' */
  real_T xseq[104];                    /* '<S81>/optimizer' */
  real_T yseq[104];                    /* '<S81>/optimizer' */
  real_T status;                       /* '<S81>/optimizer' */
  real_T xest[4];                      /* '<S81>/optimizer' */
  ...
  real_T path;                         /* '<S32>/MATLAB Function2' */
  real_T y;                            /* '<S32>/MATLAB Function' */
  real_T Add2_h;                       /* '<S3>/Add2' */
  real_T Add_f;                        /* '<S37>/Add' */
  real_T SFunction1_o1_p;              /* '<S27>/S-Function1' */
  real_T SFunction1_o2_d;              /* '<S27>/S-Function1' */
  real_T Inc2Pos_p;                    /* '<S23>/Inc2Pos' */
  real_T AbsPosition_m;                /* '<S23>/AbsPosition' */
  real_T Abs_h;                        /* '<S29>/Abs' */
  real_T TransferFcn_f;                /* '<S29>/Transfer Fcn' */
  real_T mm2m_po;                      /* '<S23>/mm2m' */
  real_T Saturation_a;                 /* '<S22>/Saturation' */
  real_T Current2V_h;                  /* '<S22>/Current2V' */
  real_T DSPscale_m;                   /* '<S22>/DSPscale' */
  real_T Add_h;                        /* '<S24>/Add' */
  ...
  uint32_T SFunction1_o4;              /* '<S12>/S-Function1' */
  uint32_T SFunction1_o1_m[3];         /* '<S11>/S-Function1' */
  uint16_T SFunction1_o6;              /* '<S12>/S-Function1' */
  uint8_T SFunction1_o1_c[12];         /* '<S12>/S-Function1' */
  uint8_T SFunction1_o5[4];            /* '<S12>/S-Function1' */
  uint8_T SFunction1_o2_f[4];          /* '<S11>/S-Function1' */
  uint8_T flag;                        /* '<S2>/MATLAB Function' */
  boolean_T DataTypeConversion;        /* '<S2>/Data Type Conversion' */
  boolean_T Memory[212];               /* '<S61>/Memory' */
  boolean_T iAout[212];                /* '<S81>/optimizer' */
  ...
  B_MATLABFunction_Ball_and_Pla_T sf_MATLABFunction_h;/* '<S49>/MATLAB Function' */
  B_MATLABFunction_Ball_and_Pla_T sf_MATLABFunction_g;/* '<S48>/MATLAB Function' */
  B_MATLABFunction1_Ball_and_Pl_T sf_MATLABFunction1_h;/* '<S18>/MATLAB Function1' */
  ...
  B_MATLABFunction_Ball_and_Pla_T sf_MATLABFunction_ko;/* '<S34>/MATLAB Function' */
  B_MATLABFunction1_Ball_and_Pl_T sf_MATLABFunction2_d;/* '<S17>/MATLAB Function2' */
  ...
  B_MATLABFunction_Ball_and_Pla_T sf_MATLABFunction_e;/* '<S21>/MATLAB Function' */
  B_MATLABFunction1_Ball_and_Pl_T sf_MATLABFunction1;/* '<S16>/MATLAB Function1' */
...
typedef struct {
  ...
  real_T DiscreteTimeIntegrator_DSTATE_p;/* '<S37>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_o;/* '<S52>/Discrete-Time Integrator' */
  real_T last_mv_DSTATE[2];            /* '<S61>/last_mv' */
  ...
  real_T last_x_PreviousInput[4];      /* '<S61>/last_x' */
  ...
  real_T index;                        /* '<S32>/MATLAB Function' */
  real_T previous_enable;              /* '<S32>/MATLAB Function' */
  struct {
    real_T RECEIVED_FRAMES;
  } SFunction1_RWORK;                  /* '<S12>/S-Function1' */

  real_T Dct1lowpass2_RWORK[2];        /* '<S8>/Dct1lowpass2' */
  real_T Dct1lowpass2_RWORK_g[2];      /* '<S9>/Dct1lowpass2' */
  struct {
    real_T RX_DROPPED_FRAMES[2];
  } SFunction1_RWORK_l;                /* '<S13>/S-Function1' */

  real_T Dctleadlag2_RWORK[2];         /* '<S24>/Dctleadlag2' */
  real_T Dct1lowpass3_RWORK[2];        /* '<S24>/Dct1lowpass3' */
  real_T Dctleadlag2_RWORK_o[2];       /* '<S37>/Dctleadlag2' */
  real_T Dct1lowpass3_RWORK_b[2];      /* '<S37>/Dct1lowpass3' */
  real_T Dctleadlag1_RWORK[2];         /* '<S52>/Dctleadlag1' */
  real_T Dct1lowpass1_RWORK[2];        /* '<S52>/Dct1lowpass1' */
  real_T Dct1lowpass2_RWORK_j[2];      /* '<S10>/Dct1lowpass2' */
  ...
  int8_T DiscreteTimeIntegrator_PrevRe_e;/* '<S52>/Discrete-Time Integrator' */
  ...
  boolean_T Memory_PreviousInput[212]; /* '<S61>/Memory' */
  ...
  DW_MATLABFunction_Ball_and_Pl_T sf_MATLABFunction_h;/* '<S49>/MATLAB Function' */
  DW_MATLABFunction_Ball_and_Pl_T sf_MATLABFunction_g;/* '<S48>/MATLAB Function' */
  DW_MATLABFunction1_Ball_and_P_T sf_MATLABFunction1_h;/* '<S18>/MATLAB Function1' */
  ...
  DW_MATLABFunction_Ball_and_Pl_T sf_MATLABFunction_ko;/* '<S34>/MATLAB Function' */
  DW_MATLABFunction1_Ball_and_P_T sf_MATLABFunction2_d;/* '<S17>/MATLAB Function2' */
  ...
  DW_MATLABFunction_Ball_and_Pl_T sf_MATLABFunction_e;/* '<S21>/MATLAB Function' */
  DW_MATLABFunction1_Ball_and_P_T sf_MATLABFunction1;/* '<S16>/MATLAB Function1' */
...
typedef struct {
  ...
  ZCSigState EMC_ENCODER_POS_SET_BL1_Trig_fh;/* '<S23>/EMC_ENCODER_POS_SET_BL1' */
...
struct P_Ball_and_Plate_MicroLabBox_student_T_ {
  ...
  real_T Dct1lowpass3_P1_Size[2];    /* Computed Parameter: Dct1lowpass3_P1_Size
                                      * Referenced by: '<S24>/Dct1lowpass3'
                                      */
  ...
  real_T Dct1lowpass1_P1_Size[2];    /* Computed Parameter: Dct1lowpass1_P1_Size
                                      * Referenced by: '<S52>/Dct1lowpass1'
                                      */
  ...
  uint16_T MatrixDimensionCheck_P1[49];
                                   ...
                                   * Referenced by: '<S62>/Matrix Dimension Check'
                                   */
  ...
  uint16_T VectorDimensionCheck_P1[49];
                                   ...
                                   * Referenced by: '<S70>/Vector Dimension Check'
                                   */
 ...
 * '<S8>'   : 'Ball_and_Plate_MicroLabBox_student/lowpass 2'
 * '<S9>'   : 'Ball_and_Plate_MicroLabBox_student/lowpass 3'
 * '<S10>'  : 'Ball_and_Plate_MicroLabBox_student/lowpass 6'
 * '<S11>'  : 'Ball_and_Plate_MicroLabBox_student/Ethernet communication/ETHERNET_SETUP_BL1'
 * '<S12>'  : 'Ball_and_Plate_MicroLabBox_student/Ethernet communication/ETHERNET_UDP_RX_BL1'
 * '<S13>'  : 'Ball_and_Plate_MicroLabBox_student/Ethernet communication/ETHERNET_UDP_SETUP_BL1'
 * '<S14>'  : 'Ball_and_Plate_MicroLabBox_student/Ethernet communication/MATLAB Function'
 * '<S15>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/AngleToPos '
 * '<S16>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_A'
 * '<S17>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_B'
 * '<S18>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_C'
 * '<S19>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/PosToAngle '
 * '<S20>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_A/MATLAB Function1'
 * '<S21>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_A/Multisine'
 * '<S22>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_A/Outputs to Amplifier'
 * '<S23>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_A/Position Measurement'
 * '<S24>'  : 'Ball_and_Plate_MicroLabBox_student/Innerloop_Actuator/Motor_A/motorA '
 ...
 * '<S61>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC'
 * '<S62>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Matrix Signal Check'
 * '<S63>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Matrix Signal Check1'
 * '<S64>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Matrix Signal Check2'
 * '<S65>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Preview Signal Check'
 * '<S66>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Preview Signal Check1'
 * '<S67>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Preview Signal Check2'
 * '<S68>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Preview Signal Check3'
 * '<S69>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Preview Signal Check4'
 * '<S70>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Scalar Signal Check'
 * '<S71>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Scalar Signal Check1'
 * '<S72>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Scalar Signal Check2'
 * '<S73>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check'
 * '<S74>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check1'
 * '<S75>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check11'
 * '<S76>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check2'
 * '<S77>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check3'
 * '<S78>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check4'
 * '<S79>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check5'
 * '<S80>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/MPC Vector Signal Check6'
 * '<S81>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/optimizer'
 * '<S82>'  : 'Ball_and_Plate_MicroLabBox_student/MPC Controller/MPC/optimizer/optimizer'
 * '<S83>'  : 'Ball_and_Plate_MicroLabBox_student/RTI Data/RTI Data Store'
 * '<S84>'  : 'Ball_and_Plate_MicroLabBox_student/RTI Data/RTI Data Store/RTI Data Store'
 * '<S85>'  : 'Ball_and_Plate_MicroLabBox_student/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 */
